...
public class PatientModifyView extends JPanel {
	int code;
	...
	JComboBox comboBox, comboBox_1, comboBox_1_1, comboBox_1_1_1, comboBox_1_1_1_1, comboBox_1_1_1_1_1,
			comboBox_1_1_1_1_1_1;
	...
	public PatientModifyView() {
		initialize();
	}
	
	public PatientModifyView(GuardianMypageView mypage, int code) {
		this.mypage=mypage;
		this.code = code;
		initialize();
	}
	...
	public void initialize() {
		...
		textField_15 = new JTextField();  //È¯ÀÚÄÚµå ¹Þ¾Æ¿À´Â ÅØ½ºÆ® ÇÊµå
		...
		textField_15.setBounds(980, 20, 200, 30);
		add(textField_15);

		JLabel lblNewLabel = new JLabel("     \uD658\uC790 \uC815\uBCF4\uB97C \uC218\uC815\uD574\uC8FC\uC138\uC694");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(PatientModifyView.this);
				frame.dispose();
			}
		});
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					dao.updatePatientInfo(vo, code);
					JOptionPane.showMessageDialog(null, "È¯ÀÚ Á¤º¸°¡ ¼öÁ¤µÇ¾ú½À´Ï´Ù.");
					mypage.patienttable();
					JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(PatientModifyView.this);
					frame.dispose();
				} catch (Exception ex) {
					JOptionPane.showMessageDialog(null, "È¯ÀÚ Á¤º¸ ¼öÁ¤ÀÌ ½ÇÆÐÇÏ¿´½À´Ï´Ù.");
					ex.printStackTrace();
				}
			}
		});
		...
		try {
			dao = new PatientInfoDAO();
			PatientInfoVO vo = dao.selectPatientInfo(code);
			textField_15.setText(code+"");
			textField.setText(vo.getPt_name());
			textField_1.setText(vo.getPt_jumin());
			if(vo.getPt_sex().equals("³²ÀÚ")) {
				chckbxNewCheckBox_22.setSelected(true);
			} else if(vo.getPt_sex().equals("¿©ÀÚ")) {
				chckbxNewCheckBox_23.setSelected(true);
			}
			textField_7.setText(vo.getPt_height());
			textField_8.setText(vo.getPt_weight());
			textField_3.setText(vo.getPt_tel());
			textField_4.setText(vo.getPt_add());
			textField_6.setText(vo.getPt_diagname());
			textField_14.setText(vo.getMg_relation());
			if(vo.getCr_no().equals("1µî±Þ")) {
				rdbtnNewRadioButton_2.setSelected(true);
			} else if(vo.getCr_no().equals("2µî±Þ")) {
				rdbtnNewRadioButton_3.setSelected(true);
			} else if(vo.getCr_no().equals("3µî±Þ")) {
				rdbtnNewRadioButton_4.setSelected(true);
			} else if(vo.getCr_no().equals("4µî±Þ")) {
				rdbtnNewRadioButton_5.setSelected(true);
			} else if(vo.getCr_no().equals("5µî±Þ")) {
				rdbtnNewRadioButton_6.setSelected(true);
			}
			comboBox.setSelectedItem(vo.getPt_condition());
			comboBox_1.setSelectedItem(vo.getPt_meal());
			comboBox_1_1.setSelectedItem(vo.getPt_urine());
			comboBox_1_1_1.setSelectedItem(vo.getPt_paral());
			comboBox_1_1_1_1.setSelectedItem(vo.getPt_exercise());
			comboBox_1_1_1_1_1.setSelectedItem(vo.getPt_bedsore());
			comboBox_1_1_1_1_1_1.setSelectedItem(vo.getPt_suction());
		} catch (Exception e) {
			// TODO: handle exception
			JOptionPane.showMessageDialog(null, "[ È¯ÀÚ Á¤º¸ Á¶È¸¿¡ ½ÇÆÐÇÏ¿´½À´Ï´Ù. ]\n"+e.getMessage());
		}
