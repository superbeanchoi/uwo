...
public class Sub_GuardianModifyView extends JPanel implements ActionListener {
	private JTextField textField_1, textField_2, textField_3, textField_4, textField_5, textField_6, textField_15;
	JButton btnNewButton_1, btnNewButton;
	private GuardianMypageView mypage;
	patientTable patientlist;
	private JTable patienttable;
	String mg_id;
	int sgcode, ptcode, row;
	...
	public Sub_GuardianModifyView() {
		// TODO Auto-generated constructor stub
		initialize();
	}
	
	public Sub_GuardianModifyView(GuardianMypageView mypage, String id, int sgcode, int ptcode, int row) {
		// TODO Auto-generated constructor stub
		this.mypage=mypage;
		this.mg_id=id;
		this.sgcode=sgcode;
	...
	public void initialize() {
		...
		textField_15 = new JTextField();  //º¸È£ÀÚÄÚµå ¹Þ¾Æ¿À´Â ÅØ½ºÆ® ÇÊµå
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(Sub_GuardianModifyView.this);
				frame.dispose();
			}
		});
		...
		try {
			dao = new SubGuardianInfoDAO();
			SubGuardianInfoVO vo = dao.selectSubGuardianInfo(sgcode);
			textField_15.setText(sgcode+"");
			textField_6.setText(ptcode+"");
			patienttable.setRowSelectionInterval(row, row);
			textField_1.setText(vo.getSg_name());
			textField_5.setText(vo.getSg_birth().substring(0, 10));
			textField_3.setText(vo.getSg_tel());
			textField_4.setText(vo.getSg_add());
			textField_2.setText(vo.getSg_relation());
		} catch (Exception e) {
			// TODO: handle exception
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(o==btnNewButton_1) {
			...
			try {
				dao.updateSubGuardianInfo(sgcode, vo);
				mypage.subGuardiantableMGMatching(textField_6.getText());
				JOptionPane.showMessageDialog(null, "ºÎº¸È£ÀÚ Á¤º¸°¡ ¼öÁ¤µÇ¾ú½À´Ï´Ù.");
				JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(Sub_GuardianModifyView.this);
				frame.dispose();
			} catch (SQLException ex) {
				JOptionPane.showMessageDialog(null, "ºÎº¸È£ÀÚ Á¤º¸ ¼öÁ¤ÀÌ ½ÇÆÐÇÏ¿´½À´Ï´Ù.");
				ex.printStackTrace();
			}
		}
	}
