...
public class CenterPatientPayModiView extends JPanel {
	...
	public CenterPatientPayModiView(CenterPayView parentView, String ptno, String msno) {
	...
	public void initialize() {
		...
		JButton patientPaySave = new JButton("\uC218\uC815");
		...
		patientPaySave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					dao.patientPayModify(vo, msno);
					JOptionPane.showMessageDialog(null, "È¯ÀÚ ¿ä¾ç º¸È£ºñ ¸í¼¼¼­°¡ ¼öÁ¤µÇ¾ú½À´Ï´Ù.");
					parentView.updatepatientpaytable(ptno);
					JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(CenterPatientPayModiView.this);
					frame.dispose();
				} catch (Exception ex) {
					JOptionPane.showMessageDialog(null, "È¯ÀÚ ¿ä¾ç º¸È£ºñ ¸í¼¼¼­ ¼öÁ¤¿¡ ½ÇÆÐÇÏ¿´½À´Ï´Ù.");
					ex.printStackTrace();
				}
		...
		try {
			CenterPayVO vo1 = dao.patientPayget(msno);
			msnotext.setText(msno);
			ptnotext.setText(vo1.getPt_no());
			msdatetext.setText(vo1.getMs_date().substring(0, 10));
			mspaytext.setText(vo1.getMs_pay_amount());
			mstaxtext.setText(vo1.getMs_tax());
			msdeposittext.setText(vo1.getMs_deposit().substring(0, 10));
			CenterPayVO vo2 = dao.getPatientBankInfo(ptno);
			dpbanktext.setText(vo2.getDp_bank());
			dpvirtualtext.setText(vo2.getDp_virtual());
		} catch (Exception e) {
			// TODO: handle exception
