...
public class CenterNursePayAddView extends JPanel {
	...
	public CenterNursePayAddView(CenterPayView parentView, String nuid) {
	...
	public void initialize() {
		...
		nursePaySave.addActionListener(new ActionListener() {
			...
			private void insertNursePay() {
				...
				try {
					dao.nursePayInsert(vo);
					JOptionPane.showMessageDialog(null, "¿ä¾ç º¸È£»ç ±Þ¿© ¸í¼¼¼­°¡ Ãß°¡µÇ¾ú½À´Ï´Ù.");
					parentView.updatenursepaytable(nuid);
					JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(CenterNursePayAddView.this);
					frame.dispose();
				} catch (Exception e) {
					JOptionPane.showMessageDialog(null, "¿ä¾ç º¸È£»ç ±Þ¿© ¸í¼¼¼­ Ãß°¡¿¡ ½ÇÆÐÇÏ¿´½À´Ï´Ù.");
					e.printStackTrace();
				}
			}
		});
