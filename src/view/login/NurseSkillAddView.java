...
public class NurseSkillAddView extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					NurseSkillAddView frame = new NurseSkillAddView();
	...
	public NurseSkillAddView(NurseNewMemDetailView parentView) {
		this();
...
//			field = skillFieldBox.getSelectedIndex();
//			name = skillnameBox.getSelectedIndex();
