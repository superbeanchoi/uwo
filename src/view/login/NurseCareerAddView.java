...
public class NurseCareerAddView extends JFrame implements ActionListener {

	private NurseNewMemDetailView parentView;
	private NurseMypageInfoView modiparentView;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					NurseCareerAddView frame = new NurseCareerAddView();
	...
	public NurseCareerAddView(NurseNewMemDetailView parentView) {
		this();
		this.parentView = parentView;
	}
	
	public NurseCareerAddView(NurseMypageInfoView parentView) {
		this();
		this.modiparentView = parentView;
	}
